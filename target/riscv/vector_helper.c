...
RVVCALL(OPIVV3, vwabdacc_vv_b, WOP_SSS_B, H2, H1, H1, DO_ABDACC)
RVVCALL(OPIVV3, vwabdacc_vv_h, WOP_SSS_H, H4, H2, H2, DO_ABDACC)
RVVCALL(OPIVV3, vwabdacc_vv_w, WOP_SSS_W, H8, H4, H4, DO_ABDACC)
RVVCALL(OPIVX3, vwabdacc_vx_b, WOP_SSS_B, H2, H1, DO_ABDACC)
RVVCALL(OPIVX3, vwabdacc_vx_h, WOP_SSS_H, H4, H2, DO_ABDACC)
RVVCALL(OPIVX3, vwabdacc_vx_w, WOP_SSS_W, H8, H4, DO_ABDACC)
RVVCALL(OPIVV3, vwabdaccu_vv_b, WOP_UUU_B, H2, H1, H1, DO_ABDACC)
RVVCALL(OPIVV3, vwabdaccu_vv_h, WOP_UUU_H, H4, H2, H2, DO_ABDACC)
RVVCALL(OPIVV3, vwabdaccu_vv_w, WOP_UUU_W, H8, H4, H4, DO_ABDACC)
RVVCALL(OPIVX3, vwabdaccu_vx_b, WOP_UUU_B, H2, H1, DO_ABDACC)
RVVCALL(OPIVX3, vwabdaccu_vx_h, WOP_UUU_H, H4, H2, DO_ABDACC)
RVVCALL(OPIVX3, vwabdaccu_vx_w, WOP_UUU_W, H8, H4, DO_ABDACC)
...
GEN_VEXT_VV(vwabdacc_vv_b, 2)
GEN_VEXT_VV(vwabdacc_vv_h, 4)
GEN_VEXT_VV(vwabdacc_vv_w, 8)
GEN_VEXT_VX(vwabdacc_vx_b, 2)
GEN_VEXT_VX(vwabdacc_vx_h, 4)
GEN_VEXT_VX(vwabdacc_vx_w, 8)
GEN_VEXT_VV(vwabdaccu_vv_b, 2)
GEN_VEXT_VV(vwabdaccu_vv_h, 4)
GEN_VEXT_VV(vwabdaccu_vv_w, 8)
GEN_VEXT_VX(vwabdaccu_vx_b, 2)
GEN_VEXT_VX(vwabdaccu_vx_h, 4)
GEN_VEXT_VX(vwabdaccu_vx_w, 8)
